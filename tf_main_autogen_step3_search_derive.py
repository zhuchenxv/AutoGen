...
from tf_evaluate_once_for_all import Trainer
...
def run_one_model(dataset=None, model=None,pre_train_logdir=None, save_logdir=None,
...
if __name__ == "__main__":
    ...
    change_structure_batch = 1  # 1, 10, 100
    ...
    run_one_model(dataset=dataset, model=model, pre_train_logdir=pre_train_logdir, save_logdir=save_logdir,
